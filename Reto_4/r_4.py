...
class r_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "r_4")
        ...
        self._fc_range = qtgui.Range(88, 108, 0.1, 100, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuencia centro MHz", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GRX_range = qtgui.Range(0, 30, 1, 20, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1e5, 1e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range((self.fc*1e6), self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range((self.fc*1E6), self.samp_rate)
...
def main(top_block_cls=r_4, options=None):
