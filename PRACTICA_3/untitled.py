...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(100, 20000, 0.01, 1000, 200)
        ...
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "GANANCIA TX", "counter", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = qtgui.Range(0, 1, 0.01, 1, 200)
